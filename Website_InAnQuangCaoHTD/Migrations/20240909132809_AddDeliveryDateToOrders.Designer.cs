...
namespace Website_InAnQuangCaoHTD.Migrations
{
    ...
    [Migration("20240909132809_AddDeliveryDateToOrders")]
            ...
            modelBuilder.Entity("Website_InAnQuangCaoHTD.Models.FlashSale", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            FlashSaleId = 1,
                            FlashSaleEndTime = new DateTime(2024, 9, 10, 20, 28, 7, 857, DateTimeKind.Local).AddTicks(4406),
                            FlashSalePrice = 800m,
                            FlashSaleStartTime = new DateTime(2024, 9, 8, 20, 28, 7, 857, DateTimeKind.Local).AddTicks(4390),
                            IsActive = true,
                            ProductId = 1
                        },
                        new
                        {
                            FlashSaleId = 2,
                            FlashSaleEndTime = new DateTime(2024, 9, 10, 20, 28, 7, 857, DateTimeKind.Local).AddTicks(4409),
                            FlashSalePrice = 1500m,
                            FlashSaleStartTime = new DateTime(2024, 9, 8, 20, 28, 7, 857, DateTimeKind.Local).AddTicks(4408),
                            IsActive = true,
                            ProductId = 2
                        });
                });
