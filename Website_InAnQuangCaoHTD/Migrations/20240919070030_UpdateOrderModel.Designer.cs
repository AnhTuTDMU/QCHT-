...
namespace Website_InAnQuangCaoHTD.Migrations
{
    ...
    [Migration("20240919070030_UpdateOrderModel")]
            ...
            modelBuilder.Entity("Website_InAnQuangCaoHTD.Models.FlashSale", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            FlashSaleId = 1,
                            FlashSaleEndTime = new DateTime(2024, 9, 20, 14, 0, 28, 559, DateTimeKind.Local).AddTicks(9410),
                            FlashSalePrice = 800m,
                            FlashSaleStartTime = new DateTime(2024, 9, 18, 14, 0, 28, 559, DateTimeKind.Local).AddTicks(9392),
                            IsActive = true,
                            ProductId = 1
                        },
                        new
                        {
                            FlashSaleId = 2,
                            FlashSaleEndTime = new DateTime(2024, 9, 20, 14, 0, 28, 559, DateTimeKind.Local).AddTicks(9414),
                            FlashSalePrice = 1500m,
                            FlashSaleStartTime = new DateTime(2024, 9, 18, 14, 0, 28, 559, DateTimeKind.Local).AddTicks(9412),
                            IsActive = true,
                            ProductId = 2
                        });
                });
