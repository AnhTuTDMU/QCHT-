...
namespace Website_InAnQuangCaoHTD.Migrations
{
    ...
    [Migration("20241104071820_AddDateCreatedToUsersModel")]
    partial class AddDateCreatedToUsersModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Website_InAnQuangCaoHTD.Models.FlashSale", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            FlashSaleId = 1,
                            FlashSaleEndTime = new DateTime(2024, 11, 5, 14, 18, 17, 426, DateTimeKind.Local).AddTicks(5328),
                            FlashSalePrice = 800m,
                            FlashSaleStartTime = new DateTime(2024, 11, 3, 14, 18, 17, 426, DateTimeKind.Local).AddTicks(5318),
                            IsActive = true,
                            ProductId = 1
                        },
                        new
                        {
                            FlashSaleId = 2,
                            FlashSaleEndTime = new DateTime(2024, 11, 5, 14, 18, 17, 426, DateTimeKind.Local).AddTicks(5335),
                            FlashSalePrice = 1500m,
                            FlashSaleStartTime = new DateTime(2024, 11, 3, 14, 18, 17, 426, DateTimeKind.Local).AddTicks(5333),
                            IsActive = true,
                            ProductId = 2
                        });
                });

            modelBuilder.Entity("Website_InAnQuangCaoHTD.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Website_InAnQuangCaoHTD.Models.UsersModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 1,
                            Address = "Bình Dương",
                            DateCreated = new DateTime(2024, 11, 4, 14, 18, 17, 426, DateTimeKind.Local).AddTicks(3112),
