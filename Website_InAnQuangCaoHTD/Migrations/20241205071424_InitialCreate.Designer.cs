...
namespace Website_InAnQuangCaoHTD.Migrations
{
    ...
    [Migration("20241205071424_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Website_InAnQuangCaoHTD.Models.ConstructionBooking", b =>
                {
                    b.Property<int>("ConstructionBookingId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ConstructionBookingId"));
                    ...
                    b.HasKey("ConstructionBookingId");

                    b.HasIndex("UserId");

                    b.ToTable("ConstructionBookings");
                });
            ...
            modelBuilder.Entity("Website_InAnQuangCaoHTD.Models.FlashSale", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            FlashSaleId = 1,
                            FlashSaleEndTime = new DateTime(2024, 12, 6, 14, 14, 23, 375, DateTimeKind.Local).AddTicks(5322),
                            FlashSalePrice = 800m,
                            FlashSaleStartTime = new DateTime(2024, 12, 4, 14, 14, 23, 375, DateTimeKind.Local).AddTicks(5316),
                            IsActive = true,
                            ProductId = 1
                        },
                        new
                        {
                            FlashSaleId = 2,
                            FlashSaleEndTime = new DateTime(2024, 12, 6, 14, 14, 23, 375, DateTimeKind.Local).AddTicks(5325),
                            FlashSalePrice = 1500m,
                            FlashSaleStartTime = new DateTime(2024, 12, 4, 14, 14, 23, 375, DateTimeKind.Local).AddTicks(5324),
                            IsActive = true,
                            ProductId = 2
                        });
                });
            ...
            modelBuilder.Entity("Website_InAnQuangCaoHTD.Models.UsersModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 1,
                            Address = "Bình Dương",
                            DateCreated = new DateTime(2024, 12, 5, 14, 14, 23, 375, DateTimeKind.Local).AddTicks(4086),
            ...
            modelBuilder.Entity("Website_InAnQuangCaoHTD.Models.UsersModel", b =>
                {
                    b.Navigation("ConstructionBookings");
